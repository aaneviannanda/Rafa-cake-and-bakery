...
class="text-center text-lg-start text-white">
    ...
    <section class="">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p class="rafa__desc">
                Rafa Cake and Bakery is a web-based application project that aims to introduce Rafa Cake and Bakery, 
                introduce what products are sold and can also order them via Whatsapp.
            </p>
        </div>
        <!-- Grid column -->
        <hr class="w-100 clearfix d-md-none" />
        <!-- Grid column -->
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 products__link">
            <h6 class="text-uppercase mb-4 font-weight-bold">Products</h6>
            <p>
                <a class="text-white">Bakery</a>
            </p>
            <p>
                <a class="text-white">Cake</a>
            </p>
        </div>
        <!-- Grid column -->
        <hr class="w-100 clearfix d-md-none" />
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3 navigation__link">
            ...
            <p>
                <a href="#" class="text-white">Favorite</a>                  
            </p>
            <p>
    ...
    <section class="p-3 pt-0">
        ...
        <div class="col-md-7 col-lg-8 text-center text-md-start text__footer">
            ...
            <div class="p-3">
            © 2022 Copyright -
            <a class="text-white" href="#">Rafa Cake & Bakery</a>
            </div>
            <!-- Copyright -->
        </div>
        <!-- Grid column -->
