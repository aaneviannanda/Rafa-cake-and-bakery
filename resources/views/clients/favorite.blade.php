...
@section('content')
    ...
    <div class="my__favorite">
        ...
        <div class="row">
            @if (count($dataFavorites) == 0)
                <div class="text-center no__favorite">"please add product to favorites first"</div>
            @else
                    ...
                    <div class="col-md-4 d-flex justify-content-center container__card">
                        <div class="card card__item" style="width: 20rem">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text card__desc">{{ $favorite->products->description }}</div>
