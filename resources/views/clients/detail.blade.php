    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 d-flex justify-content-center detail__img">
                <img src="{{ asset('product_img/'.$product->link_img) }}" alt="{{ $product->link_img }}">
            </div>
            ...
            <div class="container px-4 mt-3">
                <div class="row gx-5">
                  <div class="col">
                        <a href="https://wa.me/6285624378677" class="btn button_buy_detail">Hubungi<i class="fa fa-whatsapp fa-1.5x ms-3" aria-hidden="true"></i></a>
                  </div>
                  <div class="col">
                    @guest
                        <a href="{{ route('login') }}" class="btn button_fav_detail">Fav<i class="fa fa-heart fa-1.5x ms-3" aria-hidden="true"></i></a>
                    @else
                        <form method="POST" action="{{ route('insert_favorite') }}">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $product->id }}">
                            <button type = "submit" class="btn button_fav_detail">Fav<i class="fa fa-heart fa-1.5x ms-3" aria-hidden="true"></i></button>
                        </form>
                    @endguest
                  </div>
                </div>
